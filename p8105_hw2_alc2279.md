...
The second dataset includes precipitation data for 2016 and 2017 (i.e. number of inches of rain by month and year). It was created by combining the 2016 dataset (12 rows and 3 columns) and the 2017 dataset (8 rows and 3 columns). The resulting data is 20 observations and 3 columns. The total rainfall in 2017 that was recorded (months Jan through Aug) is 29.93.
